<!-- SELECT2 EXAMPLE -->
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Search Lecturer</b></h3>
        ...
        <div class="box-body">
          ...
          <!-- Start Radio Buttons -->
			...
			<!-- text input -->
                ...
                <input type="text" class="form-control" placeholder="Enter Lecturer Name or #ID" style="display:inline;width:33%;">
                ...
                <select class="form-control select2" data-placeholder="Select a Course" style="width: 33%;" >
                 ...
                 <input type="text" class="form-control" placeholder="Enter Batch ID" style="display:inline;width:33%;">
