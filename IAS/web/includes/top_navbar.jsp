<header class="main-header">
	...
	<!-- Logo -->
        <a href="${pageContext.request.contextPath}/${sessionScope.homePath}" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>W</b>SE</span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>WINHE</b>SE</span>
	</a>
				...
				<li class="dropdown messages-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="footer"><a href="" data-toggle="modal"
							data-target="#mail_modal">See All Messages</a></li>
					</ul></li>
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header"><img
							...
							<p>
								Alexander Pierce <small>Student Coordinator</small>
							</p></li>
						<!-- Menu Footer-->
						<li class="user-footer">
							<div class="pull-left">
								<a href="#" class="btn btn-default btn-flat" href="#" data-toggle="modal"
							data-target="#user_profile_modal">Profile</a>
							</div>
							<div class="pull-right">
								<a href="#" class="btn btn-default btn-flat" data-toggle="modal"
									data-target="#log_out_modal">Log Out</a>
							</div>
						</li>
					</ul></li>
			</ul>
