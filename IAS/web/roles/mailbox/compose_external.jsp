...
<html>
    <head>
        ...
        <title>${sessionScope.role}| Compose Message</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="mailbox.jsp" class="btn btn-success btn-block margin-bottom">Back to Inbox</a>
                        ...
                        <div class="col-md-9">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Compose New External Message</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
