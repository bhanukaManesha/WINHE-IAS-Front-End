...
<html>
    <head>
        ...
        <title>Course Coordinator | Delete Batch</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="delete_batch.jsp"><i class="fa fa-trash"></i> Delete Batch</a></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <%@include file= "../../includes/batch_delete_details.jsp"%>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-outline">Delete Batch</button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
