...
<html>
    <head>
        ...
        <title>Admission Officer  | Add Student</title>
    ...
    <body class="hold-transition skin-blue sidebar-collapse sidebar-mini">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="new_students">
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                        <form role="form" id="form_addStudent">
                                            <div class="box-body">
                                                <div class="form-group">
                                ...
                                <div class="tab-pane" id="past_students">
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <form role="form">
                                            ...
                                            <div class="box-footer">
                                                <button type="button" id="btn_studentAdd"class="btn btn-primary" style="width:100%">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- Enter Student Details Panel End -->
        ...
        <script type="text/javascript">
            ...
            jQuery('#btn_studentAdd').on('click', function (event) {
                event.preventDefault();
                console.log("submittingF");
                var form = "#form_addStudent";
                var json = ConvertFormToJSON(form);
                //				var tbody = jQuery('#to-do-list > tbody');
                console.log(json);
                $.ajax({
                    type: "POST",
                    url: "http://localhost:8081/studentss/645467798943543008081",
                    data: json,
                    dataType: "json",
