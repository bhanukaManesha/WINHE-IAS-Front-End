...
<html>
    <head>
        ...
        <title>Course Coordinator | Delete Branch</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="delete_batch.jsp"><i class="fa fa-trash"></i> Delete Branch</a></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <%@include file= "../../includes/branch_search_bar.jsp"%>

                    <%@include file= "../../includes/branch_delete_details.jsp"%>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-outline">Delete Branch</button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
